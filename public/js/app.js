...
var instaInput = document.querySelector('.instagram--post-input');
var instaButton = document.querySelector('.instagram--post-button');

function instagramPostValidation(instaInput, instaButton) {
  instaButton.addEventListener('click', function () {
    var inputValue = instaInput.value;

    if ((0,lodash__WEBPACK_IMPORTED_MODULE_1__.trim)(inputValue) !== '') {
      var regex = /(https:\/\/www.instagram.com\/p\/)+([a-zA-Z]||[0-9])/gm;
      var testInputValue = regex.test(inputValue);
      ...
      if (testInputValue !== true) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/link/add', {
          link: inputValue
        }).then(function (res) {
...
$('#dropdown--handler').on('click', function (evt) {
  evt.stopPropagation();
  var single = evt.currentTarget.getElementsByTagName("ul")[0];
    ...
    $.ajax({
      ...
      if (res.success === true) {
        ...
        res.data.forEach(function (val) {
          li += "<li class=\"py-2 px-3 border-b last:border-b-0 hover:bg-gray-100 transition-all duration-200\">\n                        <a href=\"".concat(res.url, "/project/").concat(val.slug, "\" class=\"flex\">\n                            <img class=\"w-8 h-8 object-cover rounded\" src=\"").concat(val.photo, "\" alt=\"project-image\"/>\n                            <p class=\"pl-2\">").concat(val.name, "</p>\n                        </a>\n                    </li>");
        });
