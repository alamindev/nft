           ...
           @include('frontend.includes.ads-image')
            <div class="py-10 xl:px-20">
                <div class="flex items-center mb-3 ">
                    <h2 class="text-lg font-bold ">Prelaunch</h2>
                    <div class="pl-5">
                        <input type="text" data-remote="{{ route('search') }}" autocomplete="off" placeholder="Search..."  id="search" class="py-1 px-4 rounded border border-gray-200">
