                ...
                <div class="sm:w-4/6   sm:pl-2 md:pl-5">
                    <div class="bg-white p-5">
                        <div class="flex w-full items-center justify-between border-b pb-2">
                            <p class="text-lg text-gray-800 dark:text-gray-100 font-bold">Projects</p>
                            <a href="{{ route('projects.create') }}" class="btn bg-indigo-600 text-white hover:bg-indigo-700">Create Project</a>
                        </div>
